...
namespace zcl
{
  ...
  class Cluster
  {
    ...
    static attributes_list_t create_attributes(const std::vector<AttributeDescriptor>& attribute_descriptors)
    {
...
public:
    ...
    const commands_map_t& get_commands() const
    {
        return commands_map;
    }
    ...
    ZclStatus execute_cluster_command(command_id_t id, const bool is_common, Args... args)
    {
