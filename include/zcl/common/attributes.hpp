...
namespace zcl
{
  ...
  using attr_value_t = std::variant<int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t, std::string>;
  ...
  public:
    ...
    // Constructor
    AttributeDescriptor(attr_id_t id, 
                        bool is_msp, 
                        bool is_reportable, 
                        bool is_readable, 
                        bool is_writable, 
  ...
  public:
    ...
    // Constructor
    Attribute(const AttributeDescriptor& descriptor)
